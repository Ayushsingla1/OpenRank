...
export type DataKey = {tag: "Owner", values: void} | {tag: "UsdContract", values: void} | {tag: "Game", values: readonly [string]} | {tag: "Bet", values: readonly [string, string]} | {tag: "Stakers", values: readonly [string]};
...
export interface Client {
   ...
   * Redeem winnings
   */
  redeem: ({user, game_id}: {user: string, game_id: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<i128>>>
   ...
   */
  get_bet: ({game_id, user}: {game_id: string, user: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<readonly [u128, u128]>>>

  /**
   * Construct and simulate a get_game transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   * Get game information
   */
  get_game: ({game_id}: {game_id: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<readonly [string, boolean, u32, u128, u128, u32, i128]>>>
   ...
   */
  get_amount: ({game_id, bet, shares}: {game_id: string, bet: u32, shares: u128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<u128>>>

  /**
   * Construct and simulate a initialize transaction. Returns an `AssembledTransaction` object which will have a `result` field containing the result of the simulation. If this transaction changes contract state, you will need to call `signAndSend()` on the returned object.
   */
  initialize: ({owner, usd_contract}: {owner: string, usd_contract: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  create_game: ({owner, game_id}: {owner: string, game_id: string}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
   ...
   */
  stake_amount: ({staker, game_id, shares, bet, amount}: {staker: string, game_id: string, shares: u128, bet: u32, amount: i128}, options?: MethodOptions) => Promise<AssembledTransaction<Result<readonly [u128, i128, i128]>>>
   ...
   */
  result_announced: ({owner, game_id, result}: {owner: string, game_id: string, result: u32}, options?: MethodOptions) => Promise<AssembledTransaction<Result<void>>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAQAAAAAAAAAAAAAAA0JldAAAAAACAAAAAAAAAAlub19zaGFyZXMAAAAAAAAKAAAAAAAAAAp5ZXNfc2hhcmVzAAAAAAAK",
  ...
  public readonly fromJSON = {
    redeem: this.txFromJSON<Result<i128>>,
        ...
        get_game: this.txFromJSON<Result<readonly [string, boolean, u32, u128, u128, u32, i128]>>,
